...
//	steps:
	...
	public ArrayList<String> getData(String testcasename) throws IOException {
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\lenovo\\Documents\\ToolsQA\\lastautomationtest.xlsx");
		...
		if(workbook.getSheetName(i).equalsIgnoreCase("TestCaseHSeet")) {
